        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicture = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "/img/Profile/Default.jpg"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecruterId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Candidates", x => new { x.JobId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "a4ce03e8-fb0e-4b9e-a21c-a54c3c52c963", "Admin", "ADMIN" },
                    { "2", "dc6c06e0-d42f-48da-a013-7693d842ec0c", "Recruiter", "RECRUITER" },
                    { "3", "aa57e58e-0a42-45a5-a1f6-fcb962ec1c28", "Developer", "DEVELOPER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "d166fd1c-58f2-454f-9d7f-15f30f93561d", "UserModel", "admin@jobboard.com", true, "Hassan", null, "Admin", null, false, null, "ADMIN@JOBBOARD.COM", "ADMIN", "AQAAAAEAACcQAAAAEBZ2kTjIZAXYpSSbt5KPFKvdeWh87wWTw8uI28ZrkWjePNRwsjH+IKRrmZOWOewgLQ==", null, false, "", false, "Admin" });
